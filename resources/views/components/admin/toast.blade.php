<div id="toast-success" class="hidden fixed top-2 right-0 z-[51] toast flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow" role="alert">
...
<div id="toast-danger" class="hidden fixed top-2 right-0 z-[51] toast flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow" role="alert">
...
<div id="toast-warning" class="hidden fixed top-2 right-0 z-[51] toast flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow" role="alert">
